...
impl BufferObject {
    /// Creates the shell of a `BufferObject`. No data is stored, no memory is allocated or bound.
...
///
/// [`VertexData`]: ../draw/struct.VertexData.html
...
impl Renderer {
    ...
    // Seems like it should be possible to do this more intelligently
    // than just allocating a bunch and hoping it's enough, but Vulkan
    // seems to hate any kind of dynamic resizing of anything ever and
    // the internet hasn't offered any clear solutions.
    ...
    pub fn new(
        ...
        // Various hardware-related setup things.
    ...
    pub fn render_frame(
        ...
        // Doing this every frame is probably not amazing.
        unsafe {
        ...
        let finished_command_buffer = {
            ...
            }
            {
                ...
                // Basic draw loop is:
                //      bind texture
                //      draw quads that use that texture
                //      repeat for next texture
                // The internet seems to suggest that this might not be the best solution,
    ...
    /// hardware abstraction layer. The conditions for this are unknown.
